...
import { Bell, CheckCircle2, Globe2, KeyRound, LogOut, ShieldCheck, UserRound } from "lucide-react";
...
function readPreferences() {
  ...
  try {
    return { ...defaults, ...JSON.parse(localStorage.getItem("ig_preferences") || "{}") };
  } catch {
    return defaults;
  }
}
  ...
  useEffect(() => {
    api("/api/auth/preferences")
      .then((saved) => {
        ...
        localStorage.setItem("ig_preferences", JSON.stringify(saved));
      })
      .catch(() => {});
  }, []);
