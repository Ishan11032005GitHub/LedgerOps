  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-5 xl:grid-cols-[1.4fr_1fr]">
        <ChartCard title="Monthly Transaction Volume" filename="monthly_transaction_volume" rows={data.monthly_transactions}>
      ...
      <div className="grid gap-5 xl:grid-cols-3">
        <ChartCard title="Cash Flow" filename="cash_flow" rows={data.cash_flow}>
